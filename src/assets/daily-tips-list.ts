const DailyTipsList_EN: {
...
}[] = [
  {
    ...
    photo: 'https://leocaomecover.blob.core.windows.net/projectcover/MultimediaInputBox',
  },
  {
    ...
    photo: 'https://leocaomecover.blob.core.windows.net/projectcover/Speech',
  },
  {
    ...
    photo: 'https://leocaomecover.blob.core.windows.net/projectcover/Function_Calling',
  },
  {
    ...
    photo: 'https://leocaomecover.blob.core.windows.net/projectcover/DrawImageMode',
  },
]
