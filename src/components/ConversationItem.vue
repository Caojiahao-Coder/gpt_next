...
<template>
  <div
    b="0 b-1 solid"
    class="flex flex-row gap-2 p-16px border-base cursor-pointer"
    :class="[
  ...
  >
    ...
    <div class="flex-1 h-24px w-24px overflow-hidden" style="line-height: 24px; text-overflow: ellipsis; white-space: nowrap;">
