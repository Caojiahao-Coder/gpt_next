      ...
      <div class="flex flex-col">
        ...
        <div class="bg-base border-base shadow-2xl" b="1 rd-1 solid"
          ...
          <div class="flex flex-row p-4 border-base" b="0 b-1 solid">
            ...
            <div data-cursor="block" icon-button class="i-carbon-close text-5 h-24px line-height-24px"
              @click="emits('onClose')" />
          </div>
          <div class="p-4">
            <slot />
